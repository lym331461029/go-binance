...
```shell
go get github.com/lym331461029/go-binance/v2
```
...
```golang
import (
    "github.com/lym331461029/go-binance/v2"
)
```
...
```go
import (
    "github.com/lym331461029/go-binance/v2/futures"
)
...
```go
import (
    "github.com/lym331461029/go-binance/v2/delivery"
)
